...
const useAppStore = create(
  persist(
    (set, get) => ({
      ...
      availableExchanges: {},
      sortedExchangeKeys: [], // Додаємо для збереження порядку бірж
        ...
        set((state) => {
          ...
          const selectedExchanges = {
            ...
            [exchange]:
              ...
              state.filters[marginType === 'stablecoin' ? 'tokenExchanges' : 'stablecoinExchanges'][exchange],
          };
          return {
            filters: {
              ...state.filters,
        ...
        set((state) => {
          ...
          if (tabType === 'filter') {
            ...
            newFilters.selectedExchanges = Object.keys({
              ...
              ...acc,
              [key]: DEFAULT_SETTINGS.filters.stablecoinExchanges[key] || DEFAULT_SETTINGS.filters.tokenExchanges[key],
            }), {});
          }
